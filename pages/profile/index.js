  ...
  return (
    <>
      ...
      <div className='h-screen flex flex-col overflow-hidden relative'>
        <Navbar />
        {walletAddress ? <>
          <div className='h-56 bg-gray-light flex items-center justify-center'>
            <h1 className='float-right text-primary text-2xl font-semibold'>Treating gameplay like the art it is.</h1>
          </div>
          <ProfileInfo
